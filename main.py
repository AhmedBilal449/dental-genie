...
for img_path in image_paths:
    ...
    # Iterate through disease bounding boxes
    for box, cls in zip(disease_results.boxes.xyxy, disease_results.boxes.cls):
        ...
        # Find the best matching quadrant and enumeration based on IoU
        best_quadrant_label = "?"
        ...
        # Combine labels
        label = f"Q: {best_quadrant_label} N: {best_enumeration_label} D: {disease_label}"
